...
int24 constant MIN_SLOT_INDEX = -int24(665454); // computed from log base 1.0001 of 2**-96
int24 constant MAX_SLOT_INDEX = -MIN_SLOT_INDEX; // computed from log base 1.0001 of 2**96

UD60x18 constant MIN_SQRT_PRICE = UD60x18.wrap(3552);
UD60x18 constant MAX_SQRT_PRICE = UD60x18.wrap(281467041766685615993949421480580);
